...
const API_URL = process.env.JORE_GRAPHQL_URL || 'https://kartat.hsl.fi/jore/graphql';
        ...
        csv.parse({ delimiter: ';', columns: true }, (err, data) => {
          ...
          const stops = data
            .map(stop => ({
              ...
              hasShelter:
                stop.pysakkityyppi.includes('katos') &&
                !(stop.lyhyt_nro.startsWith('Ki') && stop.pysakkityyppi.includes('teräskatos')),
            }))
